package com.gcode.plugin.version
...
object Compose {
    ...
    private const val version_compose_version = "1.2.0-beta01"
    ...
    const val compose_ui = "androidx.compose.ui:ui:$version_compose_version"
    const val compose_ui_test_junit4 = "androidx.compose.ui:ui-test-junit4:$version_compose_version"
    const val compose_ui_test_manifest = "androidx.compose.ui:ui-test-manifest:$version_compose_version"
    const val compose_ui_tooling = "androidx.compose.ui:ui-tooling:$version_compose_version"
    const val compose_ui_tooling_preview = "androidx.compose.ui:ui-tooling-preview:$version_compose_version"
